...
// Боковые грани трапеции: смещение 8.4% от ширины на всю высоту.
// Для карточки левая сторона наклонена на всю высоту: верх сдвинут вправо на 16%, низ — 0% (левая грань как у трапеции).
// Правая карточка — зеркально: верх сдвинут влево на 16%, низ — 100%.
const CLIP_LEFT  = "polygon(16% 0%, 100% 0%, 100% 100%, 0% 100%)";
const CLIP_RIGHT = "polygon(0% 0%, 84% 0%, 100% 100%, 16% 100%)";
